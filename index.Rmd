...
xaringanExtra::use_banner(
 ...
 bottom_left = "https://www.byronjaeger.com/talk/",
 exclude = c("inverse")
)
...
```{r fig-time-one, fig.align = 'left', fig.height = 6.5, fig.width = 8, echo = FALSE, dpi = 300}
figs_time$slide_one
```
...
```{r fig-time-two, fig.align = 'left', fig.height = 6.5, fig.width = 8, echo = FALSE, dpi = 300}
figs_time$slide_two
```
...
1. `tracemem` was used to discover unintentional copying

1. `glmnet`, the core algorithm of `obliqueRSF`, was replaced with Newton Raphson scoring in `aorsf`. (__Fewer operations & better IPA__).

1. Optimized with `RcppArmadillo`
